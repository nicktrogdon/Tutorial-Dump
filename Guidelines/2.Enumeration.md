...
```
- Search for interesting ACEs  ***need to find the interesting parts to look for
```powershell
...
```
- Map all the trusts of the domain.local forest  :stars:
```powershell
...
```
- List external trusts   (hm, krbtgt account)
```powershell
